            ...
            <el-container>
                ...
                <el-main>
                    ...
                    <el-form :model="form" ref="form">
                        <el-row style="height: 100px;">
                            ...
                            <el-button type="primary" round @click="dialogFormVisible = true"
                                class="right-btn">增加充值卡类型</el-button>
                                </el-form-item>
                                </el-col>
                            <el-dialog title="请填写信息" :visible.sync="dialogFormVisible">
                                <el-form :model="form">
                                    <el-form-item label="充值卡类型" :label-width="formLabelWidth">
                                        <el-input v-model="form.name" autocomplete="off" placeholder="请输入充值卡类型"></el-input>
                                    </el-form-item>
                                    <el-form-item label="价格" :label-width="formLabelWidth">
                                        <el-input v-model="form.price" autocomplete="off" placeholder="请输入充值卡价格"></el-input>
                                    </el-form-item>
                                    <el-form-item label="有效期" :label-width="formLabelWidth">
                                        <el-input v-model="form.duration" autocomplete="off" placeholder="请输入充值卡有效期"></el-input>
                                    </el-form-item>
                                </el-form>
                    ...
                    <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
                        ...
                        <el-table-column prop="name" label="充值卡类型" width="150">
                        </el-table-column>
                        <el-table-column prop="price" label="价格" width="70">
                        </el-table-column>
                        <el-table-column prop="duration" label="有效期" width="150">
                        </el-table-column>
                      ...
                      <slot slot="footer" class="dialog-footer">
                        ...
                        <el-button type="primary" @click="modify" >确 定</el-button>
                                ...
                                <el-popconfirm title="确定删除充值卡吗？" @confirm="deleteUser(scope.row.id)">
...
export default {
    methods: {
        addItem() {
            // 向list新增item
            this.$http.post("/admin/card/save", this.form)
                .then(response => {
        ...
        edit(row) {
         ...
         deleteUser(id) {
            this.$http.delete(`/admin/card/${id}`).then((response) => {
                    //request success handler
                    //const message = JSON.stringify(response.data.msg) */// 假设后端返回数据格式为 {message: '添加数据成功'}
                    if (response.data.code === 1)
                     {
       ...
       handleQuery() {
           this.$http.get("/admin/card/show").then((Response) => {
