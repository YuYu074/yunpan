...
<!--                             <el-col :span="2">
                    ...
                    <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
                        ...
                        <el-table-column prop="name" label="最近十条公告" width="750">
                        </el-table-column>
                        <el-table-column prop="time" label="发布时间" :formatter="dateFormat" width="250">
                        </el-table-column>
...
export default {
    methods: {
      ...
      /*   deleteUser(id) {
        ...
        handleQuery() {
           this.$http.get("/admin/notice/show").then((Response) => {
