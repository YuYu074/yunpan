  ...
  return new Promise((resolve, reject) => {
    Pool.getConnection((err, c) => {
      if (err) {
        ...
        c.query('SELECT id, user_name, user_signtime, user_phone, user_password, vip_id, vip_name, vip_ddl, used_space FROM `user` WHERE user_phone="' + account + '" AND user_password="' + password + '";',(err,data)=>{
          if(err){
            console.log(err);
